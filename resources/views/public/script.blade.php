<!-- jQuery -->
<script src="{{asset('APP/js/jquery.min.js')}}"></script> <!-- jQuery Library -->
<script src="{{asset('APP/js/jquery-ui.min.js')}}"></script> <!-- jQuery UI -->
<script src="{{asset('APP/js/jquery.easing.1.3.js')}}"></script> <!-- jQuery Easing - Requirred for Lightbox + Pie Charts-->

<!-- Bootstrap -->
<script src="{{asset('APP/js/bootstrap.min.js')}}"></script>

<!-- UX -->
<script src="{{asset('APP/js/scroll.min.js')}}"></script> <!-- Custom Scrollbar -->
